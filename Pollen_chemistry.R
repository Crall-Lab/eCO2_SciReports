...
W.pollen<-read.csv(file = "2022-07-14-CN.csv", header = T, na.strings = c("", "NULLL"))
H.pollen <- read.csv(file = "CN_percentages.csv", header = T, na.string = c("", "NULL"))
...
W.pollen$ratio_wt <- W.pollen$C_wt/W.pollen$N_wt
